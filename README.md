...
### Unencrypted private key - don't store this certificate in version control!

    $ openssl pkcs12 -in cert.p12 -out apple_push_notification_no_password.pem -nodes -clcerts

### Encrypted private key

    $ openssl pkcs12 -in cert.p12 -out apple_push_notification_with_password.pem -clcerts -aes256
